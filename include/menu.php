...
<nav class="blue-grey darken-1">
    <div class="nav-wrapper">
        <a href="./" class="brand-logo center hide-on-large-only"></i> </a>
                ...
                <div class="logo-side center blue-grey darken-3">
                    <?php
                        ...
                        while($data = mysqli_fetch_array($query)){
                            ...
                            if(!empty($data['nama'])){
                                echo '<h5 class="">'.$data['nama'].'</h5>';
                            } else {
                                echo '<h5 class="">Sekretariat DPRD Provinsi DKI Jakarta</h5>';
                            }
                            if(!empty($data['alamat'])){
                                echo '<p class="description-side">'.$data['alamat'].'</p>';
                            } else {
                                echo '<p class="description-side">Jl. Kebon Sirih, No. 18, Jakarta Pusat 10110</p>';
                            }
                        }
                    ?>
                </div>
        ...
        <ul class="center hide-on-med-and-down" id="nv">
            <li><a href="./" class="ams hide-on-med-and-down"><i class="material-icons md-36">mail</i></a></li>
            <li><div class="grs"></></li>
